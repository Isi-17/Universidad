...
eta=0.1;
maxEpoch=3000;
% Si maxEpoch = 2000 resulta más dificil de clasificar. De hecho se
% realiza peor.
...
for epoch=1:maxEpoch
    ...
    % Pasa de tener un eta fijo a un eta variable. Ver que pasa si es
    % variable. Puede caer en el examen. 
    %decreciente
...
%% --> Pintar los valores objetivos
figure;
plot(Z, 'b', 'DisplayName', 'Valores Objetivos');
xlabel('Índice de Muestra');
ylabel('Valor Objetivo');
legend('Location', 'Best');
title('Valores Objetivos del Conjunto de Datos');

% El rango de la función a aprender es {0, 1} pues la salida debe ser
% binaria. De hecho en la grafica de función objetivo vemos que se tiene
% salida 1 para cierto numero de iteraciones y mas adelante se tiene
% objetivo 0.
